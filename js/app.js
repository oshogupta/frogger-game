...
var count1 = 0;
var high_speed = 300;
var low_speed = 400; // Enemies our player must avoid
...
Enemy.prototype.fetch_speed = function() {
    return Math.floor(Math.random() * (high_speed - low_speed + 5) + low_speed);
};
...
Player.prototype.update = function() {
    for (var i = 0; i < 4; i++) {
        if ((this.x + 68 > allEnemies[i].x) && (this.x < allEnemies[i].x + 68) && (this.y + 68 > allEnemies[i].y) && (this.y < allEnemies[i].y + 68)) {
            this.reset();
            alert(" hurrahhh  your are done Game Over and your score is:"+" "+ count);
            count = 0;
